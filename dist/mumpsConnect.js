...
class MumpsConnect extends events_1.EventEmitter {
    constructor() {
        super();
    ...
    sendBreakpoint(file, line, onOff, condition) {
     ...
     */
    setBreakPoint(file, breakpoints) {
        const confirmedBreakpoints = [];
        if (breakpoints) {
    ...
    verifyBreakpoints() {
        ...
        for (let i = 0; i < this._activeBreakpoints.length; i++) {
            if (!merk[i]) {
                const internalBp = this.convertMumpsPosition(this._activeBreakpoints[i]);
                const bp = { 'verified': true, 'file': internalBp.file, 'line': internalBp.line, 'id': this._breakpointId++ };
                this.sendEvent('breakpointValidated', bp);
            }
        }
    }
    ...
    getSingleVar(expression) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve) => {
                const reply = { name: expression, indexCount: 0, content: "undefined", bases: [] };
                let varType = "V";
    ...
    loadSource(file) {
        ...
        if (this._sourceFile !== file) {
            ...
            try {
                this._sourceLines = (0, fs_1.readFileSync)(this._sourceFile).toString().split('\n');
            }
            catch (_a) {
    ...
    convertMumpsPosition(positionstring) {
        ...
        if (parts[1] !== undefined) {
            ...
            try {
                const filecontent = (0, fs_1.readFileSync)(file).toString().split('\n');
                const startlabel = position.split("+")[0];
...
exports.MumpsConnect = MumpsConnect;
//# sourceMappingURL=mumpsConnect.js.map